...
{
    public class PsmdMoveDetailsViewModel
    {
        ...
        public PsmdMoveDetailsViewModel(PsmdMove move, PsmdDataCollection data)
        {
            ID = move.ID;
        ...
        public PsmdMoveMultiHit MultiHitData { get; set; }
